...
class TestTokenSantanderBot

  # TestTokenSantanderBot.login("164828611","B718426.,o")
  ...
  # TestTokenSantanderBot.reuse_login("164828611","B718426.,o")
  ...
  # TestTokenSantanderBot.cartola_historica("94684501","7184","Noviembre","2021")
  # TestTokenSantanderBot.cartola_historica("164828611","9386","Noviembre","2021")
  def self.cartola_historica(therapist_rut,
    ...
    begin
      ...
      TokenSantanderApi.save_historic_data(therapist_rut,month,year,pretty_json)
  ...
  # TestTokenSantanderBot.cartola_actual("94684501","7184")
  # TestTokenSantanderBot.cartola_actual("164828611","9386")
  def self.cartola_actual(therapist_rut,
    ...
    begin
      ...
      if browser.frameset.frame(id:'2').iframe(id:'p4').radios.any?
        ...
        browser.close
        # to insert api call
        TokenSantanderApi.save_actual_data(therapist_rut,pretty_json)
        # end api call
        return pretty_json
