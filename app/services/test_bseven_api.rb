...
class TestBsevenApi
  ...
  def self.create_bhe_receptor(therapist_rut, 
                              password,
                              patient_rut,
                              region,
                              comuna,
    ...
    if server_or_test == 1
      url = URI("http://143.198.167.84/api/v1/siis_methods/createbhereceptor")
    else
      url = URI("http://localhost:3000/api/v1/siis_methods/createbhereceptor")
    end
  ...
  # server_or_test -> 0 for test 1 for server, integers
  def self.bhe_list(therapist_rut,
                    password,
                    month,
                    year)
  ...
  # server_or_test -> 0 for test 1 for server, integers
  def self.test_bhe_list(server_or_test)
  ...
  def self.test_create_bhe_receptor(server_or_test)
    ...
    if server_or_test == 1
      url = URI("http://143.198.167.84/api/v1/tokens_sii/bhe_create")
    else
      url = URI("http://localhost:3000/api/v1/tokens_sii/bhe_create")
    end
