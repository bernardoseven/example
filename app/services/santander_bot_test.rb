...
class SantanderBotTest
  ...
  def self.cartola_historica_test(month, year)
    ...
    begin
      ...
      intent = cartola_historica_test_backup(month, year)
      #return false
  ...
  def self.cartola_historica_test_backup(month, year)
    therapist_rut = "94684501"
    password = "9205"
    ...
    begin
      ...
      intent = cartola_historica_test(month, year)
      #return false
  ...
  def self.cartola_transferencias(therapist_rut,
                          password)
    ...
    #begin
      ...
      browser.frameset.frame(id:'2').element(id:'menu').element(id:'OTP').click

      browser.frameset.frame(id:'2').element(id:'TTO').click

      browser.frameset.frame(id:'2').element(id:'TO2').click

      browser.frameset.frame(id:'2').iframe(id:'p4').select_list(name:'trans').option(value:"2").click

      # considerar botón siguiente
      #array = []
