...
=end 
  ...
  def sii_login
    ...
    result = TokenSiiBot.login(params["sii"]["therapist_rut"],
                                   params["sii"]["password"])
  ...
  def bhe_create
    ...
    result = TokenSiiBot.user_retains(params["sii"]["therapist_rut"], 
                                params["sii"]["password"],
  ...
  def created_bhes
    ...
    result = TokenSiiBot.total_bhe(params["sii"]["therapist_rut"],
                          params["sii"]["password"],
                          params["sii"]["month"],
                          params["sii"]["year"])
  ...
  def delete_bhe
    ...
    result = TokenSiiBot.delete_bhe(params["sii"]["therapist_rut"], 
                               params["sii"]["password"],
